...
final class MapKitViewController: ViewController {
    ...
    private var places: [MKAnnotation] = [
    ...
    func setUpMapViewCamera() {
        let a = CLLocationDegrees("44.605713") ?? 0
        let b = CLLocationDegrees("33.535521") ?? 0
        mapView.searchRadius(currentLocation, radius: 2500)
