...
protocol BooksViewControllerProtocol {
//    var router: BooksRouter? { get set }
    
}

final class BooksViewController: UIViewController, ContactCellProtocol, BooksViewControllerProtocol {
    ...
    func configureTableView() {
        ...
        tableView.register(BooksCell.self, forCellReuseIdentifier: "\(BooksCell.self)")
    }
...
//    let cancelButton = UIButton(title: "Cancel", titleColor: .systemGreen, backgroundColor: .clear, font: .systemFont(ofSize: 20), shadow: false)
    ...
    var viewModel: BooksVeiwModelProtocol?
}


extension BooksViewController: PresenterToViewContactsProtocol {
    func printSomeInfo() {
    }
...
//                }
        let cell: BooksCell = tableView.dequeueReusableCell(for: indexPath)
